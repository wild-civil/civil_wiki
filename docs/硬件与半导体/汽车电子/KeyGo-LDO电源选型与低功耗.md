...
- **nA 级极致低功耗（电池续航怪兽）**
  ...
  - 性价比替代：**TPS7A03 / TLV7A03**（TI，200~250 nA）、**SGM2047**（圣邦微，0.6 µA）——比 25nA 高一个量级，仍远低于 µA 级，价格友好。
...
- **低噪声 / 高 PSRR（BLE 射频友好）**：KeyGo 带 2.4G 射频，电源纹波会直接进收发信噪比。
  ...
  - 注意：这类料 Iq 比 RT9193/MCP1700 高；若射频性能优先，可让「射频专属 LDO」与「数字核 LDO」分开供电。

> 经验：KeyGo 单一 LDO 供电时，**RT9193（高 PSRR + 0.3µA）已兼顾低功耗与射频**；若射频指标仍不达标，再考虑单独加一颗低噪声 RF 级 LDO。
...
4. **SGM2034**（圣邦微，SOT-23-3）：XC6206 引脚兼容平替，参数全面优于真货且避开假货坑，国产供货稳。若你更信任圣邦微渠道，可作为 RT9193 之外的第二优选。
