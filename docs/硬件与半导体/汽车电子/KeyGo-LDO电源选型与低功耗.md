...
- **I_active**：BLE 广播/连接时 MCU+射频电流（CH58x 约数 mA~数十 mA，查 [CH582M 特性与概览](../嵌入式开发/BLE MCU&SOC/WCH/CH58(2)3M/CH582M 特性与概览.md)）。
...
- 主控 CH58x 的电气参数以 [CH582M 特性与概览](../嵌入式开发/BLE MCU&SOC/WCH/CH58(2)3M/CH582M 特性与概览.md) 为准；其 3.3V 电源即本文讨论对象。
