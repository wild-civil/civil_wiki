...
<img src="assets/svg-abs-coords" style="max-width:680px;width:100%;height:auto" alt="Word 删一个元素后自动补位，SVG 原地留洞——坐标绝对最直观的代价">
...
<img src="assets/svg-op-add" style="max-width:680px;width:100%;height:auto" alt="复制相近元素并改坐标，加出一个新模块">
...
<img src="assets/svg-op-del" style="max-width:680px;width:100%;height:auto" alt="删掉元素后留下空洞，其余元素纹丝不动">
...
<img src="assets/svg-op-attr" style="max-width:680px;width:100%;height:auto" alt="linecap=round 端点变圆、linejoin=round 拐角变柔">
...
<img src="assets/svg-op-group" style="max-width:680px;width:100%;height:auto" alt="套 g transform 后整组一次性平移，子元素坐标不变">
...
<img src="assets/svg-op-text" style="max-width:680px;width:100%;height:auto" alt="y 是基线；dominant-baseline=middle 让文字垂直居中">
...
<img src="assets/svg-op-reuse" style="max-width:680px;width:100%;height:auto" alt="defs 定义一次，use 多处引用，改定义即全部生效">
