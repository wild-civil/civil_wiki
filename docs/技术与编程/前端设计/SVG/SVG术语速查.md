...
改图时高频出现的属性 / 元素，一词一解，配最小示例。完整语法去 [语法字典](../../../技术与编程/可视化与图形/SVG从认识到制作.md)；怎么改去 [SVG 动手区](./)。
...
相关：[← SVG 动手区](./) · [读图四步](./拿到一张SVG先读四件事.md) · [六种手术](./改图的六种常见手术.md) · [语法字典 →](../../../技术与编程/可视化与图形/SVG从认识到制作.md)
