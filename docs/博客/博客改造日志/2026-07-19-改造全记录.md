...
3. `mkdocs.yml` 里的地址已换成真的：
   ...
   ```yaml
   site_url: https://blog2.hanvon.top/civil_wiki/
...
4. 站点上线后访问 `https://blog2.hanvon.top/civil_wiki/`（因用户站点自定义域名继承，`wild-civil.github.io/civil_wiki/` 会 301 跳转到此），确认 GitHub Actions 构建成功。
