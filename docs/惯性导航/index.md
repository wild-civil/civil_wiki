...
### 第 1 步 · 数学地基（本系列补课重点）
- [ ] [数学地基：矩阵、概率与协方差](00_前置数学基础/数学基础.md)（含「身高-体重」真实 Python 演示）
- [ ] [矢量叉乘与反对称矩阵](00_前置数学基础/矢量叉乘与反对称矩阵.md)
- [ ] [坐标变换与旋转矩阵（推导入门）](00_前置数学基础/坐标变换与旋转矩阵.md)
- [ ] [协方差交互实验：拖点看正/负/零与单位影响](00_前置数学基础/协方差交互实验.md)
- [x] [导数与微分基础](00_前置数学基础/导数与微分基础.md)（已发布，含变化率→定义→线性逼近→求导法则→泰勒）
- [ ] 泰勒展开（规划中） ⭐ 外链：[维基 · 泰勒公式](https://zh.wikipedia.org/wiki/泰勒公式)
