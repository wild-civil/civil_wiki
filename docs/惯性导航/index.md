...
| [08b 本固件粗对准实战](02_解算篇/08b_本固件静基座粗对准实战_TRIAD与ins_align.md) | `ins_align.c` 逐函数走读：TRIAD→m2q→静止均值累积→有界状态机→注入 ESKF | ✅ 已发布（锚定本项目 AHRS 固件代码） |
| [09 纯惯导误差传播](02_解算篇/09_纯惯导误差传播.md) | 失准角增长 / 舒勒振荡(84.4min) / 高程指数发散 / 与 ESKF F 矩阵对应 | ✅ 已发布（M2 收官篇，锚定牛小骥讲义第 3 讲） |

### Tier 3 · 多源数据融合（怎么更准）→ 📁 03_组合导航篇
| 篇 | 主题 | 状态 |
|---|---|---|
...
### 第 1 步 · 数学地基（本系列补课重点）
- [ ] [数学地基：矩阵、概率与协方差](00_前置数学基础/03_数学基础.md)（含「身高-体重」真实 Python 演示）
- [ ] [矢量叉乘与反对称矩阵](00_前置数学基础/06_矢量叉乘与反对称矩阵.md)
- [ ] [坐标变换与旋转矩阵（推导入门）](00_前置数学基础/07_坐标变换与旋转矩阵.md)
- [ ] [协方差交互实验：拖点看正/负/零与单位影响](00_前置数学基础/08_协方差交互实验.md)
