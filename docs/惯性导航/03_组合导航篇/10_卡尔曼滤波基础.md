...
- **延伸阅读（外部）**：
  - 万字长文，让你一文轻松掌握卡尔曼滤波！（cnblogs，SkyXZ）：<https://www.cnblogs.com/SkyXZ/p/18660856>——中文通俗长文，覆盖 KF 五方程直觉与推导
  - OlliW. *IMU Data Fusing: Complementary, Kalman, and Mahony Filter*：<https://www.olliw.eu/2013/imu-data-fusing/>——经典 IMU 融合对比，互补滤波 / KF / Mahony 三者在姿态估计上的取舍（与本系列 07 篇姿态更新、11 篇 ESKF 互为参照）
  - 卡尔曼滤波五矩阵数值举例（本 wiki 外链扩展）：[10b 卡尔曼滤波五矩阵数值举例](10b_卡尔曼滤波五矩阵数值举例.md)——把 F/P/Q/R/H/K 用一维位置-速度例子代成具体数字，一步步手算预测 + 量测更新（§八 的"数值版"）
