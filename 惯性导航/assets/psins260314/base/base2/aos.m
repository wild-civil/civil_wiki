...
%
% See also  att2c, aoa, vn2att, vn2roll.
...
global glv;
    ...
    idx = vel>vT;
    myfig,
    subplot(311), plot(av(:,end), [av(:,1:3), att1(:,3)]/glv.deg); grid on; ylabel('Att / \circ');  legend('\theta', '\gamma', '\psi','\psi_{track}'); x=get(gca,'xlim');
